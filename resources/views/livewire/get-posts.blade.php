<div>
    ...
    @if ($posts->count() <= 0)
        <div class="mt-10">
            <div class="flex mb-10 justify-center max-w-lg mx-4 sm:mx-auto">
    ...
    @else
        <div class="mt-10">
            <div class="flex justify-center max-w-lg mx-4 sm:mx-auto">
                <div class="relative w-full mt-2">
                    <input type="text" name="search" id="search" placeholder="Search" wire:model.live="search"
                        class="block w-full rounded-md border-0 py-1.5 pr-14 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            ...
            <div>
                <div
                    class="mx-auto mt-16 mx-4 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                        ...
                        <article class="flex flex-col items-start">
                            ...
                            <div class="max-w-xl">
                                <div class="mt-8 flex items-center gap-x-4 text-xs">
                                    <time datetime="2020-03-16" class="text-gray-100">{{ $post->formatted_date }}</time>
                                    <span href="#"
                                ...
                                <div class="group relative">
                                    <h3
                                        class="mt-3 text-lg font-semibold leading-6 text-white group-hover:text-gray-200">
